...
class DataLoader(object):
    ...
    def __init__(self, max_p_num, max_p_len, max_q_len, max_char_len,
        ...
        '''
        实现了用于加载和使用百度阅读理解数据
        :param max_p_num: 最大passage数量
        :param max_p_len: 最大passage长度
        :param max_q_len: 最大question长度
        :param max_char_len: 最大字符长度
        :param train_files: 训练集
        :param dev_files: 开发集
        :param test_files: 测试集
        '''
    ...
    def _dynamic_padding(self, batch_data, pad_id, pad_char_id):
        ...
        :param pad_id:
        :param pad_char_id:
        :return: batch_data，passage的填充长度，question的填充长度
        '''
